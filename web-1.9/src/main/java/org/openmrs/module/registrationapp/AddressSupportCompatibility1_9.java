...
@Component("registrationapp.AddressSupportCompatibility")
...
public class AddressSupportCompatibility1_9 implements AddressSupportCompatibility {
	...
	public Object getAddressTemplate() {
		return AddressSupport.getInstance().getAddressTemplate().get(0);
	}
	...
	public Map<String, String> getElementRegex() {
		return AddressSupport.getInstance().getAddressTemplate().get(0).getElementRegex();
	}
}
