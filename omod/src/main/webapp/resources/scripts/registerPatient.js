...
jq(function() {
    ...
    getSimilarPatients = function (field) {
        ...
        jq.getJSON(emr.fragmentActionLink("registrationapp", "matchingPatients", "getSimilarPatients", { appId: "registrationapp" }), formData)
    ...
    $("#confirmation").on('select', function (confSection) {
        ...
        $('#exact-matches').hide();
        $.getJSON(emr.fragmentActionLink("registrationapp", "matchingPatients", "getExactPatients", { appId: "registrationapp" }), formData)
    ...
    jq('#registration').submit(function (e) {
        ...
        var formData = jq('#registration').serialize();
        $.getJSON(emr.fragmentActionLink("registrationapp", "registerPatient", "submit", { appId: "registrationapp" }), formData)
            .success(function (response) {
