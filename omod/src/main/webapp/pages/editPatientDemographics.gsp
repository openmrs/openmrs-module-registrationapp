    ...
    <form class="simple-form-ui" method="POST">
        ...
        <div id="confirmation">
            ...
            <div id="confirmationQuestion">
                Confirm submission? <p style="display: inline"><input type="submit" class="confirm right" value="${ui.message("general.yes")}" /></p><p style="display: inline"><input id="cancelSubmission" class="cancel" type="button" value="${ui.message("general.no")}" /></p>
            </div>
        </div>
    </form>
</div>
