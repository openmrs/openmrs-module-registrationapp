...
public class RegistrationSummaryFragmentControllerTest extends BaseModuleWebContextSensitiveTest {
    ...
    public void controller_shouldAddAutoGeneratedDistributedSummaryWidgets() throws Exception {
    	...
    	administrationService.setGlobalProperty(RegistrationAppConstants.DISTRIBUTE_SUMMARY_WIDGETS, "true");
    	
    	// replay
    	regSummaryFragmentcontroller.controller(fragmentconfig, fragmentModel, appFrameworkService, patientDomainWrapper
    					                        ,null, sessionContext);
    ...
    public void controller_shouldAddAutoGeneratedSummaryWidgetsFirstColumn() throws Exception {
    	// setup
    	FragmentModel fragmentModel = new FragmentModel();
    	administrationService.setGlobalProperty(RegistrationAppConstants.DISTRIBUTE_SUMMARY_WIDGETS, "false");
